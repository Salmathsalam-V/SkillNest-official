...
class Feedback(models.Model):
    community = models.ForeignKey(
        Community,  # assuming your Community model is in app 'community'
        on_delete=models.CASCADE,
        related_name='feedbacks'
    )
    creator = models.ForeignKey(
        User,  # assuming your Creator model is in app 'creator'
        on_delete=models.CASCADE,
        related_name='feedback_by'
    )
    ...
    def __str__(self):
        return f"Feedback by {self.user.username} on {self.community.name}"
